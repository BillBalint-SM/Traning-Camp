...
EXPECTED_IDS = {
    ...
    "principle.voice-interaction-bandwidth",
    "decision-guide.voice-pipeline-architecture",
    "pattern.streaming-cascaded-voice",
    "procedure.streaming-turn-detection",
    "pattern.end-to-end-omnimodal-interaction",
    "pattern.full-duplex-conversation",
    "decision-guide.reasoning-expression-coupling",
    "pattern.filler-answer-split",
    "pattern.interaction-advice-split",
    "concept.fast-slow-state-interface",
    "checklist.expressive-speech-synthesis",
    "concept.gui-agent-observation-loop",
    "decision-guide.gui-action-space",
    "procedure.multisensory-gui-grounding",
    "checklist.mobile-automation-boundary",
    "procedure.real-time-latency-budget",
    "pattern.embodied-planning-control-stack",
    "procedure.sim-to-real-transfer",
    "concept.multi-agent-classification-matrix",
    "decision-guide.shared-or-isolated-context",
    "decision-guide.collaboration-topology",
    "decision-guide.single-or-multi-agent",
    "pattern.shared-context-role-switching",
    "procedure.multi-stage-role-switch",
    "procedure.cross-domain-role-switch",
    "pattern.isolated-context-collaboration",
    "pattern.filesystem-agent-bus",
    "procedure.agent-communication-control",
    "pattern.peer-review-collaboration",
    "pattern.manager-worker-coordination",
    "pattern.peer-to-peer-handoff",
    "procedure.cross-boundary-agent-protocol",
    "checklist.multi-agent-failure-review",
    "procedure.shared-workspace-concurrency",
    "checklist.cascade-containment",
    "concept.agent-society-simulation",
    "checklist.agent-economy-governance",
    "pattern.strategic-information-asymmetry-simulation",
}
